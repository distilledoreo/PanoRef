        ...
        <main className="min-w-0">
          ...
          <DocSection id="build" visible={visibleIds.has('build')} title="Build workspace" eyebrow="Block the physical scene">
            ...
            <FeatureGrid items={[
              ...
              ['Projected Style', 'After importing and aligning a styled panorama, switch Appearance to Projected in Build or Shots to project that look onto the graybox geometry. Clay remains the authoritative geometry control; projected frames are optional appearance references.'],
