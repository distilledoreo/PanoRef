        ...
        <main className="min-w-0">
          ...
          <DocSection id="build" visible={visibleIds.has('build')} title="Build workspace" eyebrow="Block the physical scene">
            ...
            <FeatureGrid items={[
              ...
              ['Projected Style', 'After importing and aligning a styled panorama, switch Appearance to Projected in Build or Shots to preview that look on geometry. Captures and packages include clay control frames plus projected companions when a styled pano is available (Export settings can toggle either).'],
